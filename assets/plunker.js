  ...
  .factory('plunkGenerator', function ($document) {
    ...
    return function (ngVersion, bsVersion, version, module, content) {
      ...
      var indexContent = function (content, version) {
        return '<!doctype html>\n' +
          '<html ng-app="cc.autorefresh.demo">\n' +
          '  <head>\n' +
          ...
          '    <script src="http://projects.codingmonster.co.uk/angular-cc-autorefresh/cc-autorefresh-tpls-'+version+'.js"></script>\n' +
      ...
      var exampleJs = function(content) {
        return "angular.module('cc.autorefresh.demo', ['cc.autorefresh', 'ngMockE2E']);" + "\n" + content;
      };

      addField('description', 'http://projects.codingmonster.co.uk/angular-cc-autorefresh/');
